...
| Member         | Role                                                                |
| -------------- | ------------------------------------------------------------------- |
| **D. Tejdeep** | **Team Lead — Architecture, Integration, Reviews & Delivery**       |
| **Pavan**      | Frontend — React Dashboard, Metrics, Charts & MRI Visualization     |
| **Saumaditya** | Backend / Distributed — gRPC, TLS, WebSocket, APIs & Communication  |
| **Sunshika**   | DevOps / QA — Docker, CI/CD, Testing, Monitoring & Release          |
| **Mariam**     | ML / PPML — PyTorch, MONAI, 3D U-Net & Medical-Image Training       |
| **Teja**       | Federated Learning — Flower, Hospital Clients, FedAvg & Aggregation |
| **Teja**       | Security — TenSEAL, Homomorphic Encryption & Differential Privacy   |
